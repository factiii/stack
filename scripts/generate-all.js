 ...
 * ============================================================================
 * 
 * Generate docker-compose.yml and nginx.conf from core.yml
 * 
...
const DEFAULT_CONFIG_PATH = path.join(ROOT_DIR, 'core.yml');
...
# Do not edit directly - modify core.yml and re-run generator
