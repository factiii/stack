 ...
 * ============================================================================
 * 
 * Generate docker-compose.yml and nginx.conf from factiii.yml
 * 
...
const DEFAULT_CONFIG_PATH = path.join(ROOT_DIR, 'factiii.yml');
...
# Do not edit directly - modify factiii.yml and re-run generator
