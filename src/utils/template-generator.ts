...
import { parseEnvFile } from './env-validator.js';
 ...
 */
export function generateEnvTemplate(environment: string, devEnv: EnvVars): string {
 ...
 */
export function generateSecretsChecklist(): string {
  return `
