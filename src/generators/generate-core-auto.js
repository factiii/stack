...
/**
 * Generate coreAuto.yml with auto-detected values
 */
function generateCoreAuto(rootDir, options = {}) {
  const outputPath = path.join(rootDir, 'coreAuto.yml');
  ...
  if (exists) {
    ...
    if (existingContent === content) {
      console.log('⏭️  coreAuto.yml unchanged');
      return;
    }
  }
  ...
  if (exists) {
    console.log('🔄 Updated coreAuto.yml');
  } else {
    console.log('✅ Created coreAuto.yml');
  }
