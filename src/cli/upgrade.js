...
async function upgrade(options = {}) {
  ...
  console.log('🔄 Factiii Stack Upgrade Check');
  console.log('═'.repeat(70));
  console.log('');
  ...
  if (needsRegeneration) {
    ...
    try {
      ...
      console.log('   ✅ factiiiAuto.yml updated\n');
    } catch (e) {
      console.error(`   ❌ Failed to regenerate factiiiAuto.yml: ${e.message}\n`);
    }
  } else {
    console.log('   ✅ factiiiAuto.yml is up to date\n');
  }
